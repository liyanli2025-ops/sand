...
| 文档 | 内容 |
|---|---|
| `MATERIAL_PLAN.md`（本文档） | 物料/叙事/场景规划、6 幕全部素材清单、状态追踪 |
| `SCENE_DESTRUCTION_GUIDE.md` | 单场景"美 → 崩坏"叙事的制作 SOP（视角、烧灼层、文案节奏、踩坑清单） |
| `PARTICLE_MODEL_GUIDE.md` | 把 GLTF 模型转成"粒子沙雕"的全流程指南 |
| `GLTF_BBOX_GUIDE.md` | GLTF 模型加载/居中/bbox 计算的避坑经验 |
